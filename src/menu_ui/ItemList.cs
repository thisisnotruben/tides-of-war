...
namespace Game.Ui
{
    public class ItemList : Control
    {
        ...
        public void RemoveItem(int slotIdx, bool shuffle = true, bool forceClear = false, bool funnel = false)
        {
            ...
            {
                GD.Print(string.Format("{0} on method \"RemoveItem\" slotIdx out of bouds", GetName()));
            }
        }
        public void Clear()
        {
        ...
        public Pickable GetItemMetaData(int slotIdx)
        {
            ...
            {
                GD.Print(string.Format("{0} on method \"SetSlotCoolDown\" slotIdx out of bouds", GetName()));
            }
            return null;
        }
        ...
        public bool IsSlotCoolingDown(int slotIdx)
        {
            ...
            {
                GD.Print(string.Format("{0} on method \"IsSlotCoolingDown\" slotIdx out of bouds", GetName()));
            }
            return false;
        }
