...
public static class DialogicSharp
{
	...
	public static Control Start(String timeline = "", String default_timeline = "", bool useCanvasInstead = false)
	{
		return Start<Control>(timeline, default_timeline, DEFAULT_DIALOG_RESOURCE, useCanvasInstead);
	}
