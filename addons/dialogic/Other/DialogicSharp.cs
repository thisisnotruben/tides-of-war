...
public static class DialogicSharp
{
	...
	public static Control Start(String timeline, bool resetSaves = true, bool debugMode = false)
	{
		return Start<Control>(timeline, DEFAULT_DIALOG_RESOURCE, resetSaves, debugMode);
	}

	public static T Start<T>(String timeline, String dialogScenePath, bool resetSaves = true, bool debugMode = false) where T : class
	{
		return (T)_dialogic.Call("start", timeline, resetSaves, dialogScenePath, debugMode, false);
	}
